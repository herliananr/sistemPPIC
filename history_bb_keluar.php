...
<head>
    ...
    <title>Histori Bahan Baku Keluar</title>
    <?php
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $query = "SELECT a.id_bb_keluar as id_bb_keluar, a.tanggal_keluar as tanggal_keluar, a.id_bahan_baku as id_bahan_baku, b.nama_bahan_baku as nama_bahan_baku, a.qty as qty, a.uom as uom, a.keterangan as keterangan from bahan_baku_keluar a, bahan_baku b where a.id_bahan_baku=b.id_bahan_baku";
                                            $nomor=1;
