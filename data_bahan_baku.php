            ...
            <!-- Begin Page Content -->
                ...
                <?php
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div><a href="tambah_data_bahan_baku.php" class="btn btn-primary btn-icon-split mb-4">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            while($hasil = mysqli_fetch_assoc($result)){
                                                ...
                                                echo "<td>$hasil[warna]</td>";
                                                echo "<td>$hasil[bentuk]</td>";
                                                echo "<td>$hasil[spesifikasi]</td>";
                                                echo "<td>$hasil[keterangan]</td>";

                                                $pengantar=urlencode($hasil['id_bahan_baku']);

                                                echo "<td><a href=\"edit_data_bahan_baku.php?id_bahan_baku=$pengantar\" class=\"btn btn-warning\">Edit</a></td>";
                                                echo "<td><a href=\"hapus_data_bahan_baku.php?id_bahan_baku=$pengantar\" class=\"btn btn-danger\">Hapus</a></td>";
                                                echo "</tr>";
                                                $nomor++;
