...
<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        $query = "SELECT * FROM po_pk WHERE id_po='$inputID'";
        ...
        //apabila $pesan_diterima terisi setelah melakukan hapus pada suatu produk
        if ($pesan_diterima !=="") {
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="tambah_data_po.php" class="col-10 offset-1" method="post">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="inputID">ID PO</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="inputID" id="inputID" required <?php echo $idporead ?> value="<?php echo $inputID ?>">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                            ...
                                            <?php
                                                ...
                                                if ($warna=="hijau" or $penanda=="iya") {
                                                    echo "<input type=\"text\" class=\"form-control\" name=\"inputIDPartner\" id=\"inputIDPartner\" readonly value=\"$inputIDPartner\">";
                                                    
                                                    //hanya berupa trik agar javascript bisa berjalan tanpa error
                                                    $jsArrayP= "var dtPrtnr = new Array();\n";
                                                    $jsArrayP .= "dtPrtnr['" . $inputIDPartner . "'] = {namapartner:'" . addslashes($inputNamaPartner) ."'};\n";
                                                }
                                                else if ($warna=="" or $penanda==""){
                                                    echo "<select class=\"form-control\" name=\"inputIDPartner\" id=\"inputIDPartner\" onchange=\"ubahPartner(this.value)\">";
                                                    include("layout/koneksi.php");
                                                    echo"<option value=\"0\" selected>----Pilih----</option>";
                                                    $query = "select * from partner where peran='customer'";
                                                    $jsArrayP= "var dtPrtnr = new Array();\n";

                                                    $result = mysqli_query($link, $query);
                                                    while ($hasil=mysqli_fetch_assoc($result)) {
                                                        echo "<option value=\"$hasil[id_partner]\">$hasil[id_partner]</option>";
                                                        $jsArrayP .= "dtPrtnr['" . $hasil['id_partner'] . "'] = {namapartner:'" . addslashes($hasil['nama_partner']) . "'};\n";
                                                    }
                                                    echo "</select>";
                                                }
                                            ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="inputNamaPartner" id="inputNamaPartner" readonly
                                            <?php
                                                if ($warna=="hijau"or $penanda=="iya") {
                                                    echo "value=\"$inputNamaPartner\"";
                                                }
                                            ?>
                                        >
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control datepicker datetimepicker-input" name="inputTanggalTerbit" id="inputTanggalTerbit" data-provide="datepicker" data-date-format="yyyy-mm-dd" 
                                            <?php
                                                if ($warna=="hijau" or $penanda=="iya") {
                                                        echo "readonly value=\"$inputTanggalTerbit\"";
                                                        
                                                }
                                                else if ($penanda=="iya") {
                                                    echo " value=\"$inputTanggalTerbit\"";
                                                }
                                            ?>>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="inputIDProduk" id="inputIDProduk" onchange="ubahProduk(this.value)">
                                            <?php
                                                include("layout/koneksi.php");
                                                echo"<option value=\"0\" selected>----Pilih----</option>";
                                                $query = "select id_produk, nama_produk, uom from produk where (id_produk, nama_produk, uom) not in (select id_produk, nama_produk, uom from po where id_po='$inputID')"; // 
                                        ...
                                        <?php
                                            if ($inputID=="") {
                                                ...
                                                while($hasil = mysqli_fetch_assoc($result)){
                                                    ...
                                                    echo "<td><a href=\"hapus_data_produk_po.php?id_po=$pengantar&id_produk=$pengantardua\" class=\"btn btn-danger\">Hapus</a></td>";
                                                    echo "</tr>";
                                                    $nomor++;
    ...
    <script>
        ...
        function ubahPartner(inputIDPartner){
            document.getElementById('inputNamaPartner').value = dtPrtnr[inputIDPartner].namapartner;
        }
