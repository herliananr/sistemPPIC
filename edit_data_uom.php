...
<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        if (strlen($inputUOM)>20) {
            $pesan .="UOM hanya diisi maksimal 20 digit.";
        }

        elseif (strlen($inputKeterangan)>30) {
            $pesan .="Keterangan hanya diisi maksimal 25 digit";
        }


        if ($pesan==="") {
            //jalankan query edit
            $query = "update uom set keterangan='$inputKeterangan' where uom='$inputUOM'";
            $hasil = mysqli_query($link, $query);

            if ($hasil) {
                $pesandikirim .="Data dengan UOM = $inputUOM berhasil diupdate";
        ...
        //diproses setelah tombol edit pada data uom diklik
        $uom=$_GET['uom'];

        $result=mysqli_query($link, "select * from uom where uom='$uom'");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Data UOM</h6>
                        </div>
                        <div class="card-body">
                            <form action="edit_data_uom.php" class="col-10 offset-1" method="post">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="inputUOM">UOM</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="inputUOM" id="inputUOM" readonly required value="<?php echo $inputUOM ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="inputKeterangan" id="inputKeterangan" required value="<?php echo $inputKeterangan ?>">
                                    </div>
                                </div>
