                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Data Bill of Material</h6>
                        </div>
                        <div class="card-body">
                            <form action="edit_data_bom.php" class="col-10 offset-1" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="inputJumlahPemakaian" id="inputJumlahPemakaian" min="0" required value="<?php echo $inputJumlahPemakaian ?>">
                                    </div>
                                </div>
                                        ...
                                        <?php
                                            if ($inputIDProduk=="") {
                                                ...
                                                while($hasil = mysqli_fetch_assoc($result)){
                                                    ...
                                                    echo "<td><a href=\"hapus_data_pbb_bom.php?id_produk_bom=$pengantar&id_bahan_baku=$pengantardua&edit=y\" class=\"btn btn-danger\">Hapus</a></td>";
                                                    echo "</tr>";
                                                    $nomor++;
