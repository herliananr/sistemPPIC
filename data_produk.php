            ...
            <!-- Begin Page Content -->
                ...
                <?php
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div><a href="tambah_data_produk.php" class="btn btn-primary btn-icon-split mb-4">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            while($hasil = mysqli_fetch_assoc($result)){
                                                ...
                                                $pengantar=urlencode($hasil['id_produk']);

                                                echo "<td><a href=\"edit_data_produk.php?id_produk=$pengantar\" class=\"btn btn-warning\">Edit</a></td>";
                                                echo "<td><a href=\"hapus_data_produk.php?id_produk=$pengantar\" class=\"btn btn-danger\">Hapus</a></td>";
                                                echo "</tr>";
                                                $nomor++;
