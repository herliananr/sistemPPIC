...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Schedule Delivery</h6>
                        </div>
                        <div class="card-body">
                            <form action="tambah_data_schedule_delivery.php" class="col-10 offset-1" method="post">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        if ($warna=="hijau" or $penanda=="iya") {
                                            ...
                                            echo "<select class=\"form-control\" name=\"inputIDProduk\" id=\"inputIDProduk\" onchange=\"ubahProduk(this.value)\">";
                                                ...
                                                $query = "select id_produk, nama_produk, uom, qty from po where id_po='$inputID'"; // and (id_produk, nama_produk, uom) not in (select id_produk, nama_produk, uom from schedule_delivery)
                                                $jsArray= "var dtP = new Array();\n";

                                                $result = mysqli_query($link, $query);
                                                while ($hasil=mysqli_fetch_array($result)) {
                                                    echo "<option value=\"$hasil[id_produk]\">$hasil[id_produk]</option>";
                                                    $jsArray .= "dtP['" . $hasil['id_produk'] . "'] = {namaproduk:'" . addslashes($hasil['nama_produk']) . "',uomproduk:'".addslashes($hasil['uom'])."',qtyproduk:'".addslashes($hasil['qty'])."'};\n";
                                                }
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="inputQtyProduk" id="inputQtyProduk" readonly 
                                            <?php
                                                if ($warna=="hijau" or $penanda=="iya") {
                                                    echo "value=\"$inputQtyProduk\"";
                                                }
                                            ?>
                                        >
                                    </div>
                                        ...
                                        <?php
                                            if ($inputID=="") {
                                                ...
                                                while($hasil = mysqli_fetch_assoc($result)){
                                                    ...
                                                    echo "<td><a href=\"hapus_data_delv_sd.php?id_po=$pengantar&id_delv=$pengantardua&id_produk=$pengantartiga&qty_produk=$pengantarempat\" class=\"btn btn-danger\">Hapus</a></td>";
                                                    echo "</tr>";
                                                    $nomor++;
    ...
    <script>
        ...
        function ubahProduk(inputIDProduk){
            ...
            document.getElementById('inputQtyProduk').value = dtP[inputIDProduk].qtyproduk;
        }
